...
var l = o((e) => {
    ...
    function w(e, r, i, a, o) {
      ...
      if (x(e))
        for (var u = 0; u < e.length; u++)
          ((a = e[u]), (s = l + ce(a, u)), (c += w(a, r, i, s, o)));
      else if (((u = h(e)), typeof u == `function`))
        for (e = u.call(e), u = 0; !(a = e.next()).done;)
          ((a = a.value), (s = l + ce(a, u++)), (c += w(a, r, i, s, o)));
      else if (s === `object`) {
        if (typeof e.then == `function`) return w(le(e), r, i, a, o);
        throw (
          (r = String(e)),
          Error(
  ...
  h = o((e) => {
    ...
    function Le(e) {
      var t = e.memoizedState;
      (t !== null && ((sh._currentValue = t.memoizedState), D(Pe, e)),
        (t = je.current));
      var n = dp(t, e.type);
      t !== n && (D(Me, e), D(je, n));
    }
    function Re(e) {
      (Me.current === e && (Ae(je), Ae(Me)),
        Pe.current === e && (Ae(Pe), (sh._currentValue = Ee)));
    }
    var ze, Be;
    function Ve(e) {
      if (ze === void 0)
...
` +
    ...
    var Mt = Math.random().toString(36).slice(2),
      Nt = `__reactFiber$` + Mt,
      Pt = `__reactProps$` + Mt,
      Ft = `__reactContainer$` + Mt,
      It = `__reactEvents$` + Mt,
      Lt = `__reactListeners$` + Mt,
      Rt = `__reactHandles$` + Mt,
      zt = `__reactResources$` + Mt,
      Bt = `__reactMarker$` + Mt,
      Vt = `__reactLoad$` + Mt;
    function Ht(e) {
    ...
    function dn(e) {
      ...
      var n = t.getValue(),
        r = ``;
      return (
        e && (r = cn(e) ? (e.checked ? `true` : `false`) : e.value),
        (e = r),
        e !== n && (t.setValue(e), !0)
      );
    }
    ...
    function Cn(e, t, n) {
      ...
      if (((e = e.style), n != null)) {
        ...
        for (var a in t)
          ((r = t[a]),
            t.hasOwnProperty(a) && n[a] !== r && (Sn(e, a, r), (k = !0)));
    ...
    function Fn(e, t, n) {
      ...
      try {
        ...
        if (
          ((Pn = !1),
          (jn !== null || Mn !== null) &&
            (zd(), jn && ((t = jn), (e = Mn), (Mn = jn = null), Nn(t), e)))
        )
    ...
    var Jn = {
      ...
      tr = C({}, Xn, {
        ...
        movementX: function (e) {
          return `movementX` in e
            ...
            : (e !== er &&
                (er && e.type === `mousemove`
                  ? ((Qn = e.screenX - er.screenX),
                    ($n = e.screenY - er.screenY))
                  : ($n = Qn = 0),
                (er = e)),
              Qn);
        },
      ...
      nr = qn(tr),
      rr = qn(C({}, tr, { dataTransfer: 0 })),
      ir = qn(C({}, Xn, { relatedTarget: 0 })),
      ar = qn(
        C({}, Jn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
      ),
      or = qn(
        C({}, Jn, {
    ...
    var pr = qn(
      ...
      _r = qn(C({}, Jn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 })),
      vr = qn(
        C({}, tr, {
          deltaX: function (e) {
            return `deltaX` in e
      ...
      yr = qn(C({}, Jn, { newState: 0, oldState: 0, source: 0 })),
      br = [9, 13, 27, 32],
      xr = Ln && `CompositionEvent` in window,
      Sr = null;
    Ln && `documentMode` in document && (Sr = document.documentMode);
    var Cr = Ln && `TextEvent` in window && !Sr,
      wr = Ln && (!xr || (Sr && 8 < Sr && 11 >= Sr)),
      Tr = ` `,
      Er = !1;
    function Dr(e, t) {
      switch (e) {
    ...
    function Ar(e, t) {
      switch (e) {
        case `compositionend`:
          return Or(t);
        case `keypress`:
          return t.which === 32 ? ((Er = !0), Tr) : null;
        case `textInput`:
          return ((e = t.data), e === Tr && Er ? null : e);
        default:
          return null;
      }
    }
    function jr(e, t) {
      if (kr)
        return e === `compositionend` || (!xr && Dr(e, t))
          ? ((e = Un()), (Hn = Vn = Bn = null), (kr = !1), e)
          : null;
      switch (e) {
        case `paste`:
          return null;
    ...
    function Kr(e, t, n) {
      e === `focusin`
        ? (Wr(), (Fr = t), (Ir = n), Fr.attachEvent(`onpropertychange`, Gr))
        : e === `focusout` && Wr();
    }
    function qr(e) {
    ...
    var ai = Ln && `documentMode` in document && 11 >= document.documentMode,
      oi = null,
      si = null,
      ci = null,
      li = !1;
    ...
    var gi = hi(`animationend`),
      _i = hi(`animationiteration`),
      vi = hi(`animationstart`),
      yi = hi(`transitionrun`),
      bi = hi(`transitionstart`),
      xi = hi(`transitioncancel`),
      Si = hi(`transitionend`),
      Ci = new Map(),
      wi =
    ...
    function Ki(e, t, n, r, a, o) {
      var s = 0;
      if (((r = e), typeof r == `function`)) Ui(r) && (s = 1);
    ...
    function Qi(e, t) {
      if (typeof e == `object` && e) {
        var n = Zi.get(e);
        return n === void 0
          ? ((t = { value: e, source: t, stack: Ge(t) }), Zi.set(e, t), t)
          : n;
      }
    ...
    function da(e) {
      for (; e === ta;)
        ((ta = $i[--ea]), ($i[ea] = null), (na = $i[--ea]), ($i[ea] = null));
      for (; e === aa;)
        ((aa = ra[--ia]),
          (ra[ia] = null),
          (sa = ra[--ia]),
    ...
    function va(e) {
      ...
      switch (((t[Nt] = e), (t[Pt] = r), n)) {
        ...
        case `select`:
          ...
          break;
        case `textarea`:
          (Q(`invalid`, t), yn(t, r.value, r.defaultValue, r.children));
      }
      ((n = r.children),
        (typeof n != `string` &&
          typeof n != `number` &&
    ...
    function ba(e) {
      ...
      if (
        ...
        t === 27
          ...
          : (A = pa ? lm(e.stateNode.nextSibling) : null);
      return !0;
    }
    function xa() {
      ((A = pa = null), (j = !1));
    ...
    var wa = ke(null),
      ...
      Ea = null;
    function Da(e, t, n) {
      (D(wa, t._currentValue), (t._currentValue = n));
    }
    function Oa(e) {
      ((e._currentValue = wa.current), Ae(wa));
    }
    function ka(e, t, n) {
      for (; e !== null;) {
        var r = e.alternate;
      ...
      for (var a = t, o = !1; a !== null;) {
        ...
        if (a.tag === 10) {
          ...
          if (((s = s.memoizedProps), s !== null)) {
            var c = a.type;
            Zr(a.pendingProps.value, s.value) ||
              (e === null ? (e = [c]) : e.push(c));
          }
    ...
    function to(e, t) {
      t === null ? D($a, $a.current) : D($a, t.pool);
    }
    function no() {
      var e = eo();
    ...
    var uo = null;
    function fo() {
      if (uo === null) throw Error(i(459));
      var e = uo;
      return ((uo = null), e);
    }
    function po(e) {
      if (e === ro || e === ao) throw Error(i(483));
    }
    var mo = null,
      ho = 0;
    function go(e) {
    ...
    function yo(e) {
          ...
          : t !== null &&
              (t.elementType === i ||
                (typeof i == `object` &&
                  ...
                  i.$$typeof === he &&
                  lo(i) === t.type))
            ? ((t = a(t, n.props)), _o(t, n), (t.return = e), t)
            : ((t = Ki(n.type, n.key, n.props, null, e.mode, r)),
              _o(t, n),
              (t.return = e),
              t);
      }
      ...
      function d(e, t, n, r, i) {
        return t === null || t.tag !== 7
          ? ((t = qi(n, e.mode, r, i)), (t.return = e), t)
          : ((t = a(t, n)), (t.return = e), t);
      }
      function f(e, t, n) {
        if (
          ...
          return ((t = Ji(`` + t, e.mode, n)), (t.return = e), t);
        if (typeof t == `object` && t) {
          switch (t.$$typeof) {
            case ae:
              return (
                (n = Ki(t.type, t.key, t.props, null, e.mode, n)),
                _o(n, t),
                (n.return = e),
                n
              );
          ...
          if (Te(t) || Se(t))
            return ((t = qi(t, e.mode, n, null)), (t.return = e), t);
          if (typeof t.then == `function`) return f(e, go(t), n);
          if (t.$$typeof === ue) return f(e, Fa(e, t), n);
          vo(e, t);
        }
        return null;
      }
      function p(e, t, n, r) {
        ...
        if (typeof n == `object` && n) {
          ...
          if (n.$$typeof === ue) return p(e, t, Fa(e, n), r);
          vo(e, n);
        }
        return null;
      }
      function m(e, t, n, r, i) {
        ...
        if (typeof r == `object` && r) {
          ...
          if (r.$$typeof === ue) return m(e, t, n, Fa(t, r), i);
          vo(t, r);
        }
        return null;
      }
      function h(i, a, s, c) {
        ...
        if (h === s.length) return (n(i, d), j && ca(i, h), l);
        if (d === null) {
          for (; h < s.length; h++)
            ((d = f(i, s[h], c)),
              d !== null &&
      ...
      function g(a, s, c, l) {
        ...
        if (v.done) return (n(a, h), j && ca(a, g), u);
        if (h === null) {
      ...
      function _(e, r, o, c) {
        if (
          ...
          switch (o.$$typeof) {
            case ae:
              a: {
                ...
                o.type === se
                  ? ((c = qi(o.props.children, e.mode, c, o.key)),
                    _o(c, o),
                    (c.return = e),
                    (e = c))
                  : ((c = Ki(o.type, o.key, o.props, null, e.mode, c)),
                    _o(c, o),
                    (c.return = e),
                    (e = c));
              }
          ...
          if (typeof o.then == `function`) return _(e, r, go(o), c);
          if (o.$$typeof === ue) return _(e, r, Fa(e, o), c);
          vo(e, o);
        }
        return (typeof o == `string` && o !== ``) ||
          ...
          ? ((o = `` + o),
            r !== null && r.tag === 6
              ...
              : (n(e, r), (c = Ji(o, e.mode, c)), (c.return = e), (e = c)),
            s(e))
          : n(e, r);
      }
    ...
    var Po = ke(null),
      Fo = ke(0);
    function Io(e, t) {
      ((e = od), D(Fo, e), D(Po, t), (od = e | t.baseLanes));
    }
    function Lo() {
      (D(Fo, od), D(Po, Po.current));
    }
    function Ro() {
      ((od = Fo.current), Ae(Po), Ae(Fo));
    }
    var zo = ke(null),
      Bo = null;
    function Vo(e) {
    ...
    function Ho(e) {
      (D(Ko, Ko.current), D(zo, e), Bo === null && (Bo = e));
    }
    function Uo(e) {
      e.tag === 22
        ? (D(Ko, Ko.current), D(zo, e), Bo === null && (Bo = e))
    ...
    function Wo() {
      (D(Ko, Ko.current), D(zo, zo.current));
    }
    function Go(e) {
      (Ae(zo), Bo === e && (Bo = null), Ae(Ko));
    }
    var Ko = ke(0);
    function qo(e, t) {
      (D(zo, zo.current), D(Ko, t));
    }
    function Jo(e) {
      (Ae(Ko), Ae(zo), Bo === e && (Bo = null));
    }
    function Yo(e) {
      for (var t = e; t !== null;) {
        if (t.tag === 13) {
    ...
    function as(e, t, n, r, i, a) {
      return (
        ...
        (t.updateQueue = null),
        (t.lanes = 0),
        (T.H = e === null || e.memoizedState === null ? xc : Sc),
        ($o = !1),
        (a = n(r, i)),
        ($o = !1),
        Qo && (a = ss(t, n, r, i)),
    ...
    function ms(e) {
      ...
      return (
        ...
        (F === null ? t.memoizedState : F.next) === null &&
          ((t = t.alternate),
          (T.H = t === null || t.memoizedState === null ? xc : Sc)),
        e
      );
    }
    function hs(e) {
    ...
    function ys(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !Zr(o, e.memoizedState) && ((R = !0), d && ((n = Ja), n !== null)))
        )
          throw n;
        ((e.memoizedState = o),
          (e.baseState = s),
    ...
    function xs(e, t, n) {
      ...
      var s = !Zr((P || a).memoizedState, n);
      if (
        (s && ((a.memoizedState = n), (R = !0)),
        (a = a.queue),
        Ks(ws.bind(null, r, a, e), [e]),
        (e =
          a.getSnapshot !== t ||
          s ||
          (F !== null && !!(F.memoizedState.tag & 1))),
        Vs(e ? 9 : 8, { destroy: void 0 }, Cs.bind(null, r, a, n, t), null),
        e)
      ) {
    ...
    function ic(e, t, n, r, i) {
      ...
      var o = T.T,
        s = {};
      ((s.types = o === null ? null : o.types), (T.T = s), gc(e, !1, t, n));
      try {
        var c = i(),
          l = T.S;
        (l !== null && l(s, c),
    ...
    function pc(e, t, n) {
      ...
      ((n = {
        ...
        _c(e)
          ? vc(t, n)
          : ((n = Ii(e, t, n, r)), n !== null && (Pd(n, e, r), yc(n, t, r))));
    }
    function mc(e, t, n) {
      hc(e, t, n, jd());
    }
        ...
        if (
          ...
          try {
            var o = t.lastRenderedState,
              s = a(o, n);
            if (((i.hasEagerState = !0), (i.eagerState = s), Zr(s, o)))
              return (Fi(e, t, i, 0), G === null && Pi(), !1);
          } catch {}
    ...
    var bc = {
      ...
      xc = {
        ...
        useSyncExternalStore: function (e, t, n) {
          ...
          return (
            (a.queue = o),
            Gs(ws.bind(null, r, o, e), [e]),
            (r.flags |= 2048),
            Vs(9, { destroy: void 0 }, Cs.bind(null, r, o, n, t), null),
            n
          );
        },
        useId: function () {
    ...
    function Lc(e, t, n, r, a) {
      ...
      if (j)
        return (
          (t = zo.current),
          t === null
            ? (r !== ga && ((t = Error(i(423), { cause: r })), Ca(Qi(t, n))),
              (e = e.current.alternate),
              (e.flags |= 65536),
              (a &= -a),
              (e.lanes |= a),
              (r = Qi(r, n)),
              (a = Pc(e.stateNode, r, a)),
              Oo(e, a),
              Y !== 4 && (Y = 2))
            : (!(t.flags & 65536) && (t.flags |= 256),
              (t.flags |= 65536),
              (t.lanes = a),
              r !== ga && ((e = Error(i(422), { cause: r })), Ca(Qi(e, n)))),
          !1
        );
    ...
    function zc(e, t, n, r, i) {
      ...
      return (
        ...
        e !== null && !R
          ? (us(e, t, i), pl(e, t, i))
          : (j && s && ua(t), (t.flags |= 1), z(e, t, r, i), t.child)
      );
    }
    ...
    function qc(e, t, n) {
            ...
            (e = A)
              ? ((e = am(e, ha)),
                ...
                e !== null &&
                  ((t.memoizedState = {
                    dehydrated: e,
                    treeContext: aa === null ? null : { id: oa, overflow: sa },
                    retryLane: 536870912,
      ...
      if (o !== null) {
        ...
        if ((Ho(t), a)) {
          ...
          (R || ja(e, t, n, !1), (a = (n & e.childLanes) !== 0), R || a)
        ) {
          if (Po.current === null) {
            if (
              ((r = G),
              ...
              throw ((o.retryLane = s), Li(e, s), Pd(r, e, s), Rc);
            Kd();
          }
          t = Kc(e, t, n);
        } else
      ...
      return (
        (e = Wi(e.child, { mode: r.mode, children: r.children })),
        (e.ref = t.ref),
        (t.child = e),
        (e.return = t),
        e
    ...
    function Yc(e, t, n, r, i) {
      return (
        ...
        e !== null && !R
          ? (us(e, t, i), pl(e, t, i))
          : (j && r && ua(t), (t.flags |= 1), z(e, t, n, i), t.child)
      );
    }
    function Xc(e, t, n, r, i, a) {
      return (
        ...
        e !== null && !R
          ? (us(e, t, a), pl(e, t, a))
          : (j && r && ua(t), (t.flags |= 1), z(e, t, n, a), t.child)
      );
    }
    function Zc(e, t, n, r, i) {
      if ((Na(t), t.stateNode === null)) {
        ...
        (typeof o == `object` && o && (a = Pa(o)),
          ...
          Co(t),
          (o = n.contextType),
          (a.context = typeof o == `object` && o ? Pa(o) : Bi),
          (a.state = t.memoizedState),
    ...
    function nl(e, t, n) {
      ...
      return i
        ? (Wo(),
          ...
          (s = e.child),
          (c = s.sibling),
          (r = Wi(s, { mode: `hidden`, children: r.children })),
          (r.subtreeFlags = s.subtreeFlags & 1206910976),
          c === null
            ? ((i = qi(i, a, n, null)), (i.flags |= 2))
            : (i = Wi(c, i)),
          (i.return = t),
          (r.return = t),
          (r.sibling = i),
        ...
        : (Vo(t),
          (n = e.child),
          (e = n.sibling),
          (n = Wi(n, { mode: `visible`, children: r.children })),
          (n.return = t),
          (n.sibling = null),
          e !== null &&
            ((o = t.deletions),
    ...
    function ol(e, t, n, r, a, o, s, c) {
        ...
        return t.flags & 256
          ...
          : t.memoizedState === null
            ? (Wo(),
              (o = a.fallback),
              (s = t.mode),
              (a = il({ mode: `visible`, children: a.children }, s)),
              (o = qi(o, s, c, null)),
              (o.flags |= 2),
              (a.return = t),
              (o.return = t),
              ...
              bo(t, e.child, null, c),
              (a = t.child),
              (a.memoizedState = el(c)),
              (a.childLanes = tl(e, r, c)),
              (t.memoizedState = $c),
              Uc(null, a))
      ...
      if ((R || ja(e, t, c, !1), (r = (c & e.childLanes) !== 0), R || r)) {
        ...
        if (
          ((r = G),
          r !== null && ((a = Dt(r, c)), a !== 0 && a !== s.retryLane))
        )
          throw ((s.retryLane = a), Li(e, a), Pd(r, e, a), Rc);
        return (om(o) || Kd(), al(e, t, c));
      }
      return om(o)
    ...
    function pl(e, t, n) {
      ...
      if (t.child !== null) {
        for (
          e = t.child, n = Wi(e, e.pendingProps), t.child = n, n.return = t;
          e.sibling !== null;
        )
          ((e = e.sibling),
            (n = n.sibling = Wi(e, e.pendingProps)),
            (n.return = t));
        n.sibling = null;
      }
      return t.child;
    ...
    function gl(e, t, n) {
      ...
      } else ((R = !1), j && t.flags & 1048576 && la(t, na, t.index));
      switch (((t.lanes = 0), t.tag)) {
        ...
        case 1:
          return ((r = t.type), (a = Oc(r, t.pendingProps)), Zc(e, t, r, a, n));
        case 3:
          a: {
            ...
            ((a = o.element), wo(e, t), jo(t, r, null, n));
            ...
            if (
              ...
              if (r !== a) {
                ((a = Qi(Error(i(424)), t)), Ca(a), (t = Qc(e, t, r, n)));
                break a;
              }
          ...
          return (
            ...
            e === null
              ? (n = Nm(t.type, null, t.pendingProps, null))
                ? (t.memoizedState = n)
                : j || (t.stateNode = fp(t.type, t.pendingProps, Ne.current, t))
              : (t.memoizedState = Nm(
                  t.type,
                  e.memoizedProps,
                  t.pendingProps,
        ...
        case 27:
          return (
            ...
            e === null &&
              ...
              (ha = !0),
              (a = A),
              Sp(t.type) ? ((um = a), (A = lm(r.firstChild))) : (A = a)),
    ...
    function bl(e, t) {
      (t !== null && (e.flags |= 4),
        e.flags & 16384 &&
          ((t = e.tag === 22 ? 536870912 : xt()), (e.lanes |= t), (dd |= t)));
    }
    function xl(e, t) {
      if (!j)
        switch (e.tailMode) {
      ...
      switch ((da(t), t.tag)) {
        ...
        case 26:
          ...
          return (
            e === null
              ? (_l(t),
                o === null ? (B(t), vl(t, a, null, r, n)) : (B(t), yl(t, o)))
              : o
                ? o === e.memoizedState
        ...
        case 27:
          if (
            ...
            ((e = je.current),
              ba(t) ? va(t, e) : ((e = hm(a, r, n)), (t.stateNode = e), _l(t)));
          }
          return (B(t), (t.subtreeFlags &= -33554433), null);
        case 5:
        ...
        case 6:
          if (e && t.stateNode != null) e.memoizedProps !== r && _l(t);
            ...
            if (((e = Ne.current), ba(t))) {
              ...
              ((e = lp(e).createTextNode(r)), (e[Nt] = t), (t.stateNode = e));
          }
          return (B(t), null);
        case 31:
        ...
        case 13:
          if (
            ...
            if (((a = ba(t)), r !== null && r.dehydrated !== null)) {
              if (e === null) {
        ...
        case 19:
          ...
          if (((a = !!(t.flags & 128)), (o = r.rendering), o === null)) {
            if (a) xl(r, !1);
              ...
              r.tail !== null &&
                Ze() > _d &&
                ((t.flags |= 128), (a = !0), xl(r, !1), (t.lanes = 4194304));
            }
          } else {
            if (!a) {
              if (((e = Yo(o)), e !== null)) {
          ...
          if (r.tail !== null) {
            ...
            return (
              ...
              r.tailMode === `visible` || r.tailMode === `collapsed` || !n || j
                ? qo(t, o)
                : ((n = o), D(zo, t), D(Ko, n), Bo === null && (Bo = t)),
              j && ca(t, r.treeForkCount),
              e
            );
          }
        ...
        switch (t.tag) {
          ...
          case 30:
            n &&
              ...
              a !== `none` && Yl(r, n, a, (r.memoizedState = []), !0));
            break;
          default:
    ...
    function Mu(e, t, n) {
      ...
      switch (e.tag) {
        ...
        case 15:
          ...
          (Au(t, e, n),
            Nu(e),
            a & 4 && (El(3, e, e.return), Tl(3, e), El(5, e, e.return)));
          break;
        case 1:
          (Au(t, e, n),
            Nu(e),
            a & 512 && (H || r === null || Al(r, r.return)),
            a & 64 &&
              V &&
              ((e = e.updateQueue),
              e !== null &&
          ...
          if (
            ...
            if (
              ...
              if (n === null) {
                ...
                } else V || Km(o, e.type, e.stateNode);
        ...
        case 30:
          (a & 512 && (H || r === null || Al(r, r.return)),
            ...
            (s = (n & 335544064) === n),
            (c = e.memoizedProps),
            (pu = s && ki(c.default, c.update) !== `none`),
            Au(t, e, n),
            Nu(e),
            s && r !== null && k && (e.flags |= 4),
            (pu = o),
            (k = a));
          break;
        case 21:
            ...
            : (J =
                t === Rc
                  ...
                  : typeof t == `object` && t && typeof t.then == `function`
                    ...
                    : 1),
        (nd = t),
        K === null && ((Y = 1), Mc(e, Qi(t, e.current))));
    }
    function Ud() {
      var e = zo.current;
      return e === null
        ...
        case 5:
          ...
          r === pa &&
            (j
              ...
              : (ya(r), (j = !0)));
        default:
          (wl(n, t), (t = K = Gi(t, od)), (t = gl(n, t, od)));
      }
      ((e.memoizedProps = e.pendingProps), t === null ? ef(e) : (K = t));
    }
    function $d(e, t, n, r) {
      ...
      try {
        if (Lc(e, i, t, n, q)) {
          ((Y = 1), Mc(e, Qi(n, e.current)), (K = null));
          return;
        }
      } catch (t) {
        ...
        if (t.subtreeFlags & 13878 || r) {
          ...
          try {
            ...
            if (
              ...
              s &&
              s.ownerDocument &&
              ni(s.ownerDocument.documentElement, s)
            ) {
              if (c !== null && ii(s)) {
                var l = c.start,
                  u = c.end;
    ...
    function Pf() {
      if (Tf === 0) {
        var e = qa;
        (e === 0 && ((e = pt), (pt <<= 1), !(pt & 261888) && (pt = 256)),
          (Tf = e));
      }
      return Tf;
    }
            ...
            for (var m = r, h; m !== null;) {
              ...
              if (
                ...
                (g !== 5 && g !== 26 && g !== 27) ||
                  h === null ||
                  p === null ||
                  ((g = In(m, p)), g != null && d.push(qf(m, g, h))),
                f)
              )
                break;
              m = m.return;
          ...
          (b &&
            (wr &&
              ...
              (kr || b !== `onCompositionStart`
                ? b === `onCompositionEnd` && kr && (y = Un())
                : ((Bn = i),
                  (Vn = `value` in Bn ? Bn.value : Bn.textContent),
                  (kr = !0))),
            (v = Jf(r, b)),
            0 < v.length &&
              ((b = new sr(b, e, null, n, i)),
              s.push({ event: b, listeners: v }),
              y ? (b.data = y) : ((y = Or(n)), y !== null && (b.data = y)))),
            (y = Cr ? Ar(e, n) : jr(e, n)) &&
              ((b = Jf(r, `onBeforeInput`)),
              0 < b.length &&
                ((v = new sr(`onBeforeInput`, `beforeinput`, null, n, i)),
    ...
    function Xf(e, t, n, r, i) {
      for (var a = t._reactName, o = []; n !== null && n !== r;) {
        ...
        ((s !== 5 && s !== 26 && s !== 27) ||
          ...
          ((c = l),
          i
            ? ((l = In(n, a)), l != null && o.unshift(qf(n, l, c)))
            : i || ((l = In(n, a)), l != null && o.push(qf(n, l, c)))),
          (n = n.return));
      }
      ...
      switch (t) {
        ...
        case `select`:
          ...
          ((t = o),
            (n = s),
            (e.multiple = !!r),
            t == null ? n != null && _n(e, !!r, n, !0) : _n(e, !!r, t, !1));
          return;
        case `textarea`:
    ...
    function Om(e, t, n) {
      ...
      if (r && e && t) {
        ...
        t === `image` && n && n.imageSrcSet
          ? ((i += `[imagesrcset="` + pn(n.imageSrcSet) + `"]`),
            typeof n.imageSizes == `string` &&
              (i += `[imagesizes="` + pn(n.imageSizes) + `"]`))
          : (i += `[href="` + pn(e) + `"]`);
        var a = i;
        switch (t) {
          case `style`:
    ...
    function Lm(e, t, n, r) {
      if ((t = e.querySelector(`link[rel="preload"][as="style"][` + t + `]`))) {
        ...
        ((t = e.createElement(`link`)),
          (t[Vt] = !0),
          (t.onload = t.onerror = qt.bind(null, t)),
          np(t, `link`, n),
          O(t),
          ...
          for (; i !== null;) {
            ...
            if (a !== null)
              switch (a.tag) {
                ...
                case 31:
                case 13:
                  ((s = Li(a, 2)), s !== null && Pd(s, a, 2), zd(), ph(a, 2));
              }
...
function ee(e) {
  return /^0\d{10}$/.test(e)
    ? `${e.slice(0, 4)} ${e.slice(4, 7)} ${e.slice(7)}`
    : e;
}
function te(e) {
  return e === `rest` ? `REST API` : e === `semaphore` ? `Semaphore` : e;
}
function x(e) {
  if (e.provider !== `semaphore`) return [];
  let t =
    e.payload && typeof e.payload == `object` && !Array.isArray(e.payload)
      ? e.payload
      : {};
  return [
    [`Semaphore Message ID`, String(e.provider_message_id ?? `—`)],
    [`Type`, typeof t.type == `string` ? t.type : `Single`],
    [`Network`, typeof t.network == `string` ? t.network : `Unknown`],
    ...(typeof t.code_text == `string` ? [[`OTP Code`, t.code_text]] : []),
  ];
}
var ne = o((e) => {
    var t = Symbol.for(`react.transitional.element`),
...
function re({ connected: e }) {
  return (0, S.jsxs)(`footer`, {
    className: `flex h-11 shrink-0 items-center gap-2 border-t px-5 text-[11px] text-black/40 dark:text-white/35`,
    children: [
      (0, S.jsx)(`span`, {
        className: `h-1.5 w-1.5 rounded-full ${e ? `bg-emerald-500 shadow-[0_0_0_3px_rgba(16,185,129,.12)]` : `bg-amber-500`}`,
      }),
      (0, S.jsx)(`span`, { children: e ? `Running` : `Reconnecting` }),
      (0, S.jsx)(`span`, {
...
var C = (e) => e.replace(/([a-z0-9])([A-Z])/g, `$1-$2`).toLowerCase(),
  ie = (e) =>
  ...
  w = (e, t) => {
    let n = (0, _.forwardRef)(({ className: n, ...r }, i) =>
      (0, _.createElement)(le, {
        ref: i,
        iconNode: t,
        className: oe(`lucide-${C(ae(e))}`, `lucide-${e}`, n),
        ...r,
      }),
    );
    return ((n.displayName = ae(e)), n);
  },
  ue = w(`book-open`, [
  ...
  de = w(`check`, [[`path`, { d: `M20 6 9 17l-5-5`, key: `1gmf2c` }]]),
  fe = w(`chevron-left`, [[`path`, { d: `m15 18-6-6 6-6`, key: `1wnfg3` }]]),
  pe = w(`chevron-right`, [[`path`, { d: `m9 18 6-6-6-6`, key: `mthhwq` }]]),
  me = w(`code-xml`, [
...
function T({ name: e, className: t = `h-5 w-5` }) {
  let n = Te[e];
  return (0, S.jsx)(n, {
    className: t,
    strokeWidth: 1.8,
...
var E = {
  neutral: `border-gray-400 bg-black/5 text-black/50 hover:bg-black/10 dark:bg-white/10 dark:text-white/50`,
...
function Ee({
  ...
  return (0, S.jsx)(`button`, {
    ...
    "aria-label": t,
    title: a.title ?? t,
    className: `rounded-lg border p-2 shadow-sm ${E[n]} ${i}`,
    ...a,
    children: (0, S.jsx)(T, { name: e, className: r }),
  });
}
function De({ message: e, onCopy: t, compact: n = !1 }) {
  let r = JSON.stringify(e.payload, null, 2),
    i = e.provider === `semaphore` ? `Raw request` : `Raw request payload`;
  return (0, S.jsxs)(`section`, {
    className: n ? `mt-4` : `mt-6`,
    children: [
      (0, S.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, S.jsxs)(`button`, {
            type: `button`,
            onClick: () => t(r, `Payload copied`),
            className: `inline-flex items-center gap-1 text-[10px] text-accent`,
            children: [
              (0, S.jsx)(T, { name: `copy`, className: `h-3 w-3` }),
              `Copy`,
            ],
          }),
        ],
      ...
      (0, S.jsx)(`pre`, {
        className: `scrollbar-none overflow-auto bg-[#171719] text-[#d6d6db] ${n ? `max-h-64 rounded-lg p-3 text-[10px] leading-5` : `rounded-2xl p-4 text-[11px] leading-5`}`,
        children: (0, S.jsx)(`code`, { children: r }),
      }),
    ],
  });
}
function Oe({ message: e, number: t, onCopy: n, onDelete: r }) {
  let i = [
    [`UUID`, e.id],
    [`To`, e.to],
    [`From`, e.from ?? `—`],
    [`Provider`, te(e.provider)],
    ...x(e),
    [`Status`, e.status],
    [`Timestamp`, b(e.created_at)],
  ];
  return (0, S.jsxs)(`article`, {
    className: `overflow-hidden rounded-xl border border-gray-400 bg-[#fafafa] shadow-sm dark:bg-white/[.025]`,
    children: [
      (0, S.jsxs)(`header`, {
        className: `flex items-center justify-between gap-3 border-b border-gray-300 px-4 py-3`,
        children: [
          (0, S.jsxs)(`div`, {
            className: `min-w-0`,
            children: [
              ...
              (0, S.jsx)(`p`, {
                className: `mt-0.5 truncate text-xs text-black/40 dark:text-white/35`,
                children: b(e.created_at),
              }),
            ],
          }),
          (0, S.jsxs)(`div`, {
      ...
      (0, S.jsxs)(`div`, {
        ...
        children: [
          (0, S.jsx)(`div`, {
            className: `rounded-lg border border-gray-300 bg-white p-3 text-sm leading-6 text-black/75 dark:bg-white/[.035] dark:text-white/75`,
            children: e.message,
          }),
          (0, S.jsx)(`dl`, {
            ...
            children: i.map(([e, t]) =>
              (0, S.jsxs)(
                `div`,
                {
                  ...
                  children: [
                    (0, S.jsx)(`dt`, {
                      className: `text-[9px] font-medium uppercase text-black/30 dark:text-white/25`,
                      children: e,
                    }),
                    (0, S.jsxs)(`dd`, {
                      ...
                      children: [
                        (0, S.jsx)(`code`, {
                          className: `min-w-0 flex-1 break-all text-[10px] leading-4 text-black/65 dark:text-white/60`,
                          children: t,
                        }),
                        t !== `—` &&
                          (0, S.jsx)(`button`, {
                            type: `button`,
                            onClick: () => n(t, `${e} copied`),
          ...
          (0, S.jsx)(De, { message: e, onCopy: n, compact: !0 }),
        ],
      }),
    ],
  });
}
function ke({ theme: e, onChange: t, className: n = `` }) {
  let r = e === `dark` ? `light` : `dark`;
  return (0, S.jsx)(`button`, {
    type: `button`,
    onClick: () => t(r),
    className: `${n} rounded-full p-2 text-[#242424] hover:bg-black/5 hover:text-black/70 dark:text-white/35 dark:hover:bg-white/10 dark:hover:text-white/70`,
    "aria-label": `Switch to ${r} mode`,
    children: (0, S.jsx)(T, {
      name: e === `dark` ? `sun` : `moon`,
      className: `h-4 w-4`,
    }),
  });
}
function Ae({ onCopy: e, theme: t, onThemeChange: n, provider: r }) {
  let i = `${window.location.origin}${r === `semaphore` ? `/api/v4/messages` : `/api/messages`}`,
    a =
      r === `semaphore`
  ...
  return (0, S.jsxs)(`div`, {
    ...
    children: [
      (0, S.jsx)(`div`, {
        ...
        children: (0, S.jsx)(ke, { theme: t, onChange: n }),
      }),
      (0, S.jsxs)(`div`, {
        className: `w-full max-w-xl text-center`,
        children: [
          (0, S.jsx)(`div`, {
            className: `mx-auto mb-5 grid h-16 w-16 place-items-center rounded-[22px] bg-accent text-2xl font-bold text-white shadow-lg shadow-accent/20`,
            children: `T`,
          }),
          (0, S.jsx)(`h2`, {
          ...
          (0, S.jsx)(`p`, {
            className: `mt-2 text-sm text-[#242424] dark:text-white/40`,
            children: `Send your first SMS request to:`,
          }),
          (0, S.jsxs)(`button`, {
            type: `button`,
            onClick: () => e(i, `Endpoint copied`),
            ...
            children: [
              (0, S.jsx)(T, { name: `copy`, className: `h-3.5 w-3.5` }),
              ` POST `,
              i,
            ],
          }),
          (0, S.jsxs)(`div`, {
            className: `relative mt-7 text-left`,
            children: [
              (0, S.jsx)(`pre`, {
                className: `scrollbar-none overflow-x-auto rounded-2xl border border-gray-400 bg-[#f5f5f7] p-4 pr-12 text-[11px] leading-5 text-black/65 shadow-sm dark:bg-[#1c1c1e] dark:text-white/60`,
                children: (0, S.jsx)(`code`, { children: a }),
              }),
              (0, S.jsx)(`button`, {
                type: `button`,
                onClick: () => e(a, `cURL copied`),
                ...
                children: (0, S.jsx)(T, { name: `copy`, className: `h-4 w-4` }),
              }),
            ],
          }),
        ],
...
function D() {
  return (0, S.jsx)(`div`, {
    ...
    children: (0, S.jsxs)(`div`, {
      ...
      children: [
        (0, S.jsx)(`div`, {
          className: `mx-auto grid h-12 w-12 place-items-center rounded-xl border bg-[#fafafa] text-sm font-semibold text-black/55 dark:bg-white/[.035] dark:text-white/55`,
          children: `T`,
        }),
        (0, S.jsx)(`p`, {
          className: `mt-4 text-sm font-medium text-black/55 dark:text-white/55`,
          children: `Loading inbox`,
        }),
        (0, S.jsx)(`p`, {
          className: `mt-1 text-xs text-black/30 dark:text-white/30`,
          children: `Reading captured messages…`,
        }),
      ],
    }),
  });
...
function je() {
  return (0, S.jsx)(`div`, {
    ...
    children: (0, S.jsxs)(`div`, {
      ...
      children: [
        (0, S.jsx)(`div`, {
          className: `mx-auto grid h-12 w-12 place-items-center rounded-xl border bg-[#fafafa] text-sm font-semibold text-black/45 dark:bg-white/[.035] dark:text-white/45`,
          children: `T`,
        }),
        (0, S.jsx)(`p`, {
          className: `mt-4 text-sm font-medium text-black/55 dark:text-white/55`,
        ...
        (0, S.jsx)(`p`, {
          className: `mt-1 text-xs text-black/30 dark:text-white/30`,
          children: `Choose a recipient from the inbox.`,
        }),
      ],
    }),
  });
}
function Me({ mode: e, onChange: t }) {
  return (0, S.jsx)(`div`, {
    className: `flex items-center gap-0.5 rounded-lg border border-gray-400 bg-black/[.045] p-0.5 shadow-sm dark:bg-white/[.06]`,
    "aria-label": `Message view`,
    children: [`phone`, `developer`].map((n) =>
      (0, S.jsxs)(
        `button`,
        {
          type: `button`,
          onClick: () => t(n),
          "aria-pressed": e === n,
          title: `${n === `phone` ? `Phone` : `Developer`} view`,
          className: `flex h-8 items-center gap-1.5 rounded-md px-2 text-[11px] ${e === n ? `border border-gray-300 bg-white font-medium text-black shadow-sm dark:bg-[#303034] dark:text-white` : `text-black/40 dark:text-white/40`}`,
          children: [
            (0, S.jsx)(T, { name: n, className: `h-3.5 w-3.5` }),
            (0, S.jsx)(`span`, {
              className: `hidden sm:inline`,
              children: n === `phone` ? `Phone` : `Developer`,
            }),
          ],
        },
        n,
...
function Ne({
  ...
  return (
    (0, _.useEffect)(
      () => window.localStorage.setItem(`teks-view-mode`, f),
      [f],
    ),
    (0, _.useEffect)(
      () => m.current?.scrollIntoView(),
      [e?.messages.length, e?.recipient],
    ),
    (0, S.jsxs)(`section`, {
      className: `${e || !n ? `flex` : `hidden lg:flex`} min-h-0 min-w-0 flex-col overflow-hidden border-x border-gray-300 bg-white dark:bg-[#111113]`,
      children: [
        t
          ? (0, S.jsx)(D, {})
          : e
            ? (0, S.jsxs)(S.Fragment, {
                children: [
                  (0, S.jsxs)(`header`, {
                    className: `glass z-10 flex h-[72px] shrink-0 items-center justify-between border-b border-gray-300 px-4 sm:px-6`,
                    children: [
                      (0, S.jsxs)(`div`, {
                          ...
                          (0, S.jsxs)(`div`, {
                            ...
                            children: [
                              (0, S.jsx)(`h2`, {
                                ...
                                children: ee(e.recipient),
                              }),
                              (0, S.jsxs)(`p`, {
                                className: `mt-0.5 text-[11px] text-black/40 dark:text-white/35`,
                                children: [
                                  e.messages.length,
                                  ` `,
                                  e.messages.length === 1
                      ...
                      (0, S.jsxs)(`div`, {
                        ...
                        children: [
                          ...
                          (0, S.jsx)(Me, { mode: f, onChange: p }),
                          (0, S.jsx)(Ee, {
                            icon: `trash`,
                            label: `Delete conversation with ${e.recipient}`,
                            tone: `red`,
                            onClick: () => d(e),
                          }),
                          (0, S.jsx)(Ee, {
                            ...
                            tone: `blue`,
                            onClick: () => l(e.recipient, `Number copied`),
                          }),
                        ],
                      }),
                    ],
                  ...
                  f === `phone`
                    ? (0, S.jsx)(`div`, {
                        ...
                        children: (0, S.jsxs)(`div`, {
                          ...
                          children: [
                            (0, S.jsx)(`p`, {
                              className: `mb-5 text-center text-[11px] font-medium uppercase text-black/30 dark:text-white/25`,
                              children: `Captured by Teks`,
                            }),
                            e.messages.map((t, n) => {
                              let r = e.messages[n - 1],
                                i =
                                  !r ||
                              ...
                              return (0, S.jsxs)(
                                `div`,
                                {
                                  ...
                                  children: [
                                    i &&
                                      (0, S.jsx)(`span`, {
                                        className: `mb-2 mt-3 pr-1 text-[10px] text-[#242424] dark:text-white/30`,
                                        children: b(t.created_at),
                                      }),
                                    (0, S.jsx)(`button`, {
                                      type: `button`,
                                      onClick: () => c(t),
                                    ...
                                    (0, S.jsxs)(`span`, {
                                      className: `mt-1 pr-1 text-[10px] text-black/30 dark:text-white/25`,
                                      children: [
                                        y(t.created_at),
                                        ` · `,
                                        t.status,
        ...
        (0, S.jsx)(`div`, {
          className: `lg:hidden`,
          children: (0, S.jsx)(re, { connected: r }),
        }),
      ],
    })
  );
}
function Pe({ message: e, onClose: t, onCopy: n, onDelete: r }) {
  let i = [
    [`UUID`, e.id],
    [`To`, e.to],
    [`From`, e.from ?? `—`],
  ...
  return (0, S.jsx)(`div`, {
    className: `fixed inset-0 z-30 bg-black/20 backdrop-blur-[2px] dark:bg-black/45`,
    onMouseDown: t,
    children: (0, S.jsxs)(`aside`, {
      ...
      children: [
        ...
        (0, S.jsx)(`div`, {
          className: `space-y-1 rounded-2xl border border-gray-400 bg-white/50 p-2 shadow-sm dark:bg-white/[.035]`,
          children: i.map(([e, t]) =>
            (0, S.jsxs)(
              `div`,
              {
                ...
                children: [
                  (0, S.jsx)(`span`, {
                    className: `w-20 shrink-0 text-xs text-black/40 dark:text-white/35`,
                    children: e,
                  }),
                  (0, S.jsx)(`span`, {
                    className: `min-w-0 flex-1 break-all text-right text-xs font-medium`,
                    children: t,
                  }),
                  t !== `—` &&
                    (0, S.jsx)(`button`, {
        ...
        (0, S.jsxs)(`section`, {
          ...
          children: [
            (0, S.jsx)(`h3`, {
              className: `mb-2 text-xs font-medium text-[#242424] dark:text-white/40`,
              children: `Message`,
            }),
            (0, S.jsx)(`div`, {
              className: `rounded-2xl bg-accent p-4 text-sm leading-6 text-white`,
              children: e.message,
            }),
          ],
        }),
        (0, S.jsx)(De, { message: e, onCopy: n }),
        (0, S.jsxs)(`button`, {
          type: `button`,
          onClick: () => r(e),
          ...
          children: [
            (0, S.jsx)(T, { name: `trash`, className: `h-4 w-4` }),
            `Delete message`,
          ],
        }),
      ],
    ...
    children: [
      (0, S.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, S.jsx)(`h1`, {
            ...
            children: `What's Teks?`,
          }),
          (0, S.jsx)(`p`, {
            className: `mx-auto mt-4 max-w-xl text-sm leading-6 text-black/55 dark:text-white/45`,
            children: `Teks is a local SMS testing inbox. It captures the messages your application tries to send so you can build and debug messaging flows without contacting a real provider or delivering a real SMS.`,
          }),
        ],
      }),
      (0, S.jsx)(`div`, {
        className: `mt-9 grid gap-3 sm:grid-cols-3`,
        children: Fe.map(([e, t, n]) =>
          (0, S.jsxs)(
            `article`,
            {
              ...
              children: [
                (0, S.jsx)(`span`, {
                  ...
                  children: (0, S.jsx)(T, { name: n, className: `h-4 w-4` }),
                }),
                (0, S.jsx)(`h2`, {
                ...
                (0, S.jsx)(`p`, {
                  className: `mt-2 text-xs leading-5 text-black/45 dark:text-white/40`,
                  children: t,
                }),
              ],
            },
      ...
      (0, S.jsx)(`div`, {
        ...
        children: (0, S.jsxs)(`button`, {
          ...
          children: [
            `Continue `,
            (0, S.jsx)(T, { name: `next`, className: `h-4 w-4` }),
          ],
        }),
      }),
    ],
...
var Le = {
  ...
  Re = [
    ...
    },
    {
      ...
      payload: { event: `new-message`, data: Le },
    },
  ],
  ze = {
    message_id: 1,
...
function Ve(e) {
  return e === `semaphore` ? Be : Re;
}
function He({ provider: e, onBack: t, onComplete: n }) {
  return (0, S.jsxs)(`div`, {
    className: `mx-auto max-w-2xl`,
    children: [
      (0, S.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, S.jsxs)(`h1`, {
            className: `mt-3 text-3xl font-semibold tracking-tight sm:text-4xl`,
            children: [te(e), ` endpoints`],
          }),
          (0, S.jsxs)(`p`, {
            className: `mx-auto mt-3 max-w-lg text-sm leading-6 text-black/50 dark:text-white/45`,
            children: [
      ...
      (0, S.jsx)(`div`, {
        className: `mt-8 max-h-[38vh] space-y-2 overflow-y-auto rounded-2xl border border-gray-400 bg-white p-2 shadow-sm dark:bg-[#19191b]`,
        children: Ve(e).map((e) =>
          (0, S.jsxs)(
            `div`,
            {
              ...
              children: [
                (0, S.jsx)(`span`, {
                  className: `mt-0.5 w-11 shrink-0 font-mono text-[10px] font-semibold ${e.method === `GET` ? `text-blue-600 dark:text-blue-400` : e.method === `POST` ? `text-emerald-600 dark:text-emerald-400` : `text-red-600 dark:text-red-400`}`,
                  children: e.method,
                }),
                (0, S.jsxs)(`span`, {
                  ...
                  children: [
                    ...
                    (0, S.jsx)(`span`, {
                      className: `mt-1 block text-[10px] leading-4 text-black/40 dark:text-white/35`,
      ...
      (0, S.jsxs)(`div`, {
        ...
        children: [
          (0, S.jsxs)(`button`, {
            ...
            children: [
              (0, S.jsx)(T, { name: `back`, className: `h-4 w-4` }),
              `Back`,
            ],
          }),
          (0, S.jsxs)(`button`, {
...
function We({ provider: e, onSelect: t, onBack: n }) {
  let [r, i] = (0, _.useState)(null);
  async function a(e) {
    (i(e), await t(e), i(null));
  }
  return (0, S.jsxs)(`div`, {
    children: [
      (0, S.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, S.jsx)(`h1`, {
            className: `mt-3 text-3xl font-semibold tracking-tight sm:text-4xl`,
            children: `What's your provider?`,
          }),
          (0, S.jsx)(`p`, {
            className: `mx-auto mt-3 max-w-lg text-sm leading-6 text-black/50 dark:text-white/45`,
            children: `Choose the API your application uses. Only the selected provider's endpoints will accept requests.`,
          }),
        ],
      }),
      (0, S.jsx)(`div`, {
        className: `mx-auto mt-9 grid max-w-2xl gap-4 sm:grid-cols-2`,
        children: Ue.map((t) => {
          let n = t.id === e,
            i = t.id === r;
          return (0, S.jsxs)(
            `button`,
            {
              ...
              children: [
                ...
                (0, S.jsx)(`p`, {
                  className: `mt-2 text-xs leading-5 text-black/50 dark:text-white/40`,
                ...
                (0, S.jsxs)(`div`, {
                  ...
                  children: [
                    (0, S.jsx)(`code`, {
                      className: `text-[10px] text-black/40 dark:text-white/35`,
                      children: t.endpoint,
                    }),
                    (0, S.jsxs)(`span`, {
      ...
      (0, S.jsxs)(`button`, {
        ...
        children: [
          (0, S.jsx)(T, { name: `back`, className: `h-3.5 w-3.5` }),
          `Back`,
        ],
      }),
    ],
...
var Ge = [`About Teks`, `Provider`, `Get started`];
function Ke({ step: e }) {
  return (0, S.jsx)(`nav`, {
        ...
        return (0, S.jsxs)(
          `li`,
          {
            ...
            children: [
              n > 0 &&
                (0, S.jsx)(`span`, {
                  className: `absolute right-1/2 top-4 h-px w-full ${r <= e ? `bg-accent` : `bg-black/10 dark:bg-white/10`}`,
                }),
              (0, S.jsx)(`span`, {
                className: `relative z-10 grid h-8 w-8 place-items-center rounded-full border text-xs font-semibold ${i || a ? `border-accent bg-accent text-white` : `border-black/15 bg-[#f2f2f2] text-black/35 dark:border-white/15 dark:bg-[#0d0d0f] dark:text-white/30`}`,
                children: i
                  ? (0, S.jsx)(T, { name: `check`, className: `h-3.5 w-3.5` })
                  : r,
              }),
              (0, S.jsx)(`span`, {
                className: `mt-2 text-[10px] font-medium sm:text-xs ${a ? `text-black dark:text-white` : `text-black/35 dark:text-white/30`}`,
                children: t,
              }),
            ],
          },
...
function qe({
  ...
  return (0, S.jsx)(`main`, {
    className: `h-dvh overflow-y-auto bg-[#f2f2f2] px-5 py-8 dark:bg-[#0d0d0f] sm:px-8`,
    children: (0, S.jsxs)(`div`, {
      ...
      children: [
        (0, S.jsxs)(`header`, {
          ...
          children: [
            (0, S.jsxs)(`div`, {
              ...
              children: [
                (0, S.jsx)(`div`, {
                  className: `grid h-10 w-10 place-items-center rounded-xl bg-accent text-base font-bold text-white shadow-sm shadow-accent/20`,
                  children: `T`,
                }),
                (0, S.jsxs)(`div`, {
                  children: [
                    ...
                    (0, S.jsx)(`p`, {
                      className: `text-[11px] text-black/40 dark:text-white/35`,
                      children: `Local SMS testing`,
                    }),
                  ],
                }),
              ],
        ...
        (0, S.jsx)(Ke, { step: o }),
        (0, S.jsxs)(`section`, {
          className: `my-auto py-10 sm:py-14`,
          children: [
            o === 1 && (0, S.jsx)(Ie, { onContinue: () => s(2) }),
            o === 2 &&
              (0, S.jsx)(We, { provider: e, onSelect: c, onBack: () => s(1) }),
            o === 3 &&
              (0, S.jsx)(He, {
                provider: e,
                onBack: () => s(2),
        ...
        (0, S.jsx)(`p`, {
          className: `pb-2 text-center text-[11px] text-black/35 dark:text-white/30`,
          children: `You can revisit setup later from Teks Status.`,
        }),
      ],
    }),
  });
...
function Je({
  ...
  let [c, l] = (0, _.useState)(``),
    u = (0, _.useMemo)(() => {
      let t = new Map();
      for (let n of e)
        `${n.to} ${n.from ?? ``} ${n.message}`
          .toLowerCase()
          .includes(c.toLowerCase()) &&
          t.set(n.to, [...(t.get(n.to) ?? []), n]);
      return [...t.entries()]
        .map(([e, t]) => {
          let n = t.sort(
            (e, t) => Date.parse(e.created_at) - Date.parse(t.created_at),
          );
          return { recipient: e, messages: n, latest: n[n.length - 1] };
        })
        .sort(
          (e, t) =>
            Date.parse(t.latest.created_at) - Date.parse(e.latest.created_at),
        );
    }, [e, c]);
  return (0, S.jsxs)(`aside`, {
    className: `${n || e.length === 0 ? `hidden lg:flex` : `flex`} min-h-0 min-w-0 flex-col border-r border-gray-300 bg-[#fafafa] dark:bg-[#19191b]`,
    children: [
      (0, S.jsxs)(`header`, {
        ...
        children: [
            ...
            children: [
              (0, S.jsxs)(`div`, {
                children: [
                  ...
                  (0, S.jsx)(`p`, {
                    className: `mt-0.5 text-xs text-black/40 dark:text-white/40`,
                    children: `Local SMS inbox`,
                  }),
                ],
              }),
              (0, S.jsxs)(`div`, {
          ...
          (0, S.jsxs)(`label`, {
            className: `flex h-9 items-center gap-2 rounded-lg border border-gray-400 bg-white px-3 text-black/40 ring-accent/20 focus-within:ring-2 dark:bg-white/[.04] dark:text-white/40`,
            children: [
              (0, S.jsx)(T, { name: `search`, className: `h-4 w-4` }),
              (0, S.jsx)(`input`, {
                value: c,
      ...
      (0, S.jsxs)(`div`, {
        className: `scrollbar-none flex-1 overflow-y-auto px-2 pb-2`,
        children: [
          t &&
            (0, S.jsx)(`p`, {
              className: `px-4 py-10 text-center text-sm text-black/40 dark:text-white/35`,
              children: `Loading inbox…`,
            }),
          !t &&
            e.length > 0 &&
          ...
          u.map((e) => {
            ...
            return (0, S.jsxs)(
              ...
              {
                type: `button`,
                onClick: () => o(e.recipient),
                className: `group mb-2 w-full rounded-lg border border-gray-400 px-3 py-3 text-left shadow-sm ${t ? `bg-accent text-white` : `hover:bg-black/[.04] dark:hover:bg-white/[.05]`}`,
                children: [
                  (0, S.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, S.jsx)(`span`, {
                        className: `shrink-0 text-[11px] ${t ? `text-white/70` : `text-[#242424] dark:text-white/30`}`,
                        children: y(e.latest.created_at),
                      }),
                    ],
                  }),
                  (0, S.jsxs)(`div`, {
                    className: `mt-1 flex items-center gap-2 ${t ? `text-white/75` : `text-[#242424] dark:text-white/40`}`,
                    children: [
                      (0, S.jsx)(`p`, {
                        className: `min-w-0 flex-1 truncate text-[13px] leading-5`,
                        children: e.latest.message,
                      }),
                      e.messages.length > 1 &&
                        (0, S.jsx)(`span`, {
                          className: `rounded-full px-1.5 py-0.5 text-[10px] font-semibold ${t ? `bg-white/20` : `bg-black/[.06] dark:bg-white/10`}`,
                          children: e.messages.length,
                        }),
                    ],
                  }),
                  e.latest.from &&
                    (0, S.jsxs)(`p`, {
                      className: `mt-0.5 truncate text-[11px] ${t ? `text-white/55` : `text-black/30 dark:text-white/25`}`,
                      children: [`from `, e.latest.from],
                    }),
                ],
              },
              e.recipient,
...
function Ye({ text: e }) {
  return (0, S.jsxs)(`div`, {
    className: `fixed bottom-7 left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 rounded-full bg-[#252527] px-4 py-2 text-sm font-medium text-white shadow-xl`,
    children: [
      (0, S.jsx)(T, { name: `check`, className: `h-4 w-4 text-emerald-400` }),
      e,
    ],
  });
}
function Xe({ theme: e, onChange: t }) {
  return (0, S.jsxs)(`section`, {
    className: `mt-7`,
    children: [
      (0, S.jsx)(`p`, {
      ...
      (0, S.jsx)(`div`, {
        className: `mt-3 grid grid-cols-2 gap-1 rounded-lg border border-gray-400 bg-black/[.045] p-1 shadow-sm dark:bg-white/[.06]`,
        children: [`light`, `dark`].map((n) =>
          (0, S.jsxs)(
            `button`,
            {
              type: `button`,
              onClick: () => t(n),
              "aria-pressed": e === n,
              className: `flex items-center justify-center gap-1.5 rounded-md py-1.5 text-xs ${e === n ? (n === `light` ? `border border-gray-300 bg-white font-medium text-black shadow-sm` : `border border-gray-300 bg-[#303034] font-medium text-white shadow-sm`) : `text-[#242424] hover:text-black dark:text-white/40 dark:hover:text-white`}`,
              children: [
                (0, S.jsx)(T, {
                  name: n === `light` ? `sun` : `moon`,
                  className: `h-3.5 w-3.5`,
                }),
                n === `light` ? `Light` : `Dark`,
              ],
...
function Ze({ provider: e }) {
  let [t, n] = (0, _.useState)(null),
    r = Ve(e);
  return (
    (0, _.useEffect)(() => n(null), [e]),
    (0, S.jsxs)(`section`, {
      className: `mt-7`,
      "aria-labelledby": `api-endpoints-title`,
      children: [
        (0, S.jsx)(`p`, {
                ...
                children: [
                  (0, S.jsxs)(`button`, {
                    ...
                    children: [
                      (0, S.jsxs)(`span`, {
                        ...
                        children: [
                          (0, S.jsx)(`span`, {
                            className: `w-10 shrink-0 font-mono text-[9px] font-semibold ${a}`,
                            children: e.method,
                          }),
                          (0, S.jsx)(`code`, {
                            className: `min-w-0 truncate text-[10px] font-medium text-black/65 dark:text-white/65`,
                            children: e.path,
                          }),
                        ],
                      }),
                      (0, S.jsx)(`span`, {
                        className: `mt-1 block pl-12 text-[9px] leading-4 text-[#242424] dark:text-white/30`,
                        children: e.description,
                      }),
                    ],
                  }),
                  i &&
                    (0, S.jsxs)(`div`, {
                      ...
                      children: [
                        (0, S.jsx)(`p`, {
                          className: `mb-1.5 text-[9px] font-medium text-[#242424] dark:text-white/30`,
                          children: e.payloadLabel,
                        }),
                        (0, S.jsx)(`pre`, {
                          className: `scrollbar-none max-h-52 overflow-auto rounded-md bg-[#171719] p-2.5 text-[9px] leading-4 text-[#d6d6db]`,
...
function Qe({ provider: e, onChoose: t }) {
  return (0, S.jsxs)(`section`, {
    className: `mt-4`,
    children: [
      (0, S.jsx)(`p`, {
      ...
      (0, S.jsxs)(`button`, {
        ...
        children: [
          (0, S.jsx)(`span`, {
            className: `grid h-8 w-8 shrink-0 place-items-center rounded-md bg-accent/10 text-accent`,
            children: (0, S.jsx)(T, {
              name: e === `semaphore` ? `phone` : `developer`,
              className: `h-4 w-4`,
            }),
          }),
          (0, S.jsxs)(`span`, {
            ...
            children: [
              ...
              (0, S.jsx)(`span`, {
                className: `mt-0.5 block text-[10px] text-black/40 dark:text-white/30`,
                children: `Change provider`,
              }),
            ],
          }),
          (0, S.jsx)(T, {
            name: `next`,
            className: `h-4 w-4 text-black/25 dark:text-white/25`,
          }),
        ],
      }),
    ],
        ...
        children: $e.map((e) =>
          (0, S.jsxs)(
            `a`,
            {
              ...
              target: `_blank`,
              rel: `noreferrer`,
              className: `group flex items-center gap-3 rounded-lg border border-gray-400 py-2.5 pe-4 ps-2 shadow-sm hover:bg-black/[.04] dark:hover:bg-white/[.05]`,
              children: [
                (0, S.jsx)(`span`, {
                  className: `grid h-8 w-8 shrink-0 place-items-center rounded-md border border-gray-300 bg-white text-[#242424] dark:bg-white/[.04] dark:text-white/45`,
                  children: (0, S.jsx)(T, {
                    name: e.icon,
                    className: `h-4 w-4`,
                  }),
                ...
                (0, S.jsxs)(`span`, {
                  ...
                  children: [
                    ...
                    (0, S.jsx)(`span`, {
                      className: `mt-0.5 block truncate text-[10px] text-[#242424] dark:text-white/30`,
                      children: e.hint,
                    }),
                  ],
                }),
...
function tt({
  ...
  return (0, S.jsxs)(`aside`, {
    className: `scrollbar-none hidden min-h-0 min-w-0 flex-col overflow-y-auto border-l border-gray-300 bg-[#fafafa] p-5 xl:flex dark:bg-[#19191b]`,
    children: [
      (0, S.jsxs)(`section`, {
        children: [
          (0, S.jsx)(`p`, {
            className: `text-[11px] font-medium uppercase text-[#242424] dark:text-white/30`,
            children: `Teks status`,
          }),
          (0, S.jsxs)(`div`, {
            className: `mt-3 rounded-lg border border-gray-400 bg-white p-3 shadow-sm dark:bg-white/[.035]`,
            children: [
              (0, S.jsxs)(`div`, {
                className: `flex items-center gap-2`,
                children: [
                  (0, S.jsx)(`span`, {
                    className: `h-2 w-2 rounded-full ${e ? `bg-emerald-500` : `bg-amber-500`}`,
                  }),
                  (0, S.jsx)(`span`, {
                    className: `text-sm font-medium`,
                    children: e ? `Running` : `Reconnecting`,
                  }),
                ],
              }),
              (0, S.jsx)(`p`, {
                className: `mt-2 font-mono text-[10px] text-black/40 dark:text-white/35`,
                children: window.location.host,
              }),
            ],
          }),
      ...
      (0, S.jsx)(Qe, { provider: r, onChoose: i }),
      (0, S.jsx)(Xe, { theme: t, onChange: n }),
      (0, S.jsx)(et, {}),
      (0, S.jsx)(Ze, { provider: r }),
      (0, S.jsxs)(`footer`, {
        className: `mt-auto pt-4 text-[10px] text-black/30 dark:text-white/25`,
        children: [
          (0, S.jsx)(`p`, { children: `Teks 0.1.0` }),
          (0, S.jsx)(`p`, {
            className: `mt-1`,
            children: `Local SMS testing for developers.`,
          }),
        ],
      }),
    ],
...
function nt() {
  let [e, t] = (0, _.useState)([]),
    ...
    [f, p] = (0, _.useState)(() => {
      let e = window.localStorage.getItem(`teks-theme`);
    ...
    [m, h] = (0, _.useState)(() =>
      window.localStorage.getItem(`teks-provider`) === `semaphore`
        ? `semaphore`
        : `rest`,
    ),
    [g, v] = (0, _.useState)(
  ...
  ((0, _.useEffect)(() => {
    (document.documentElement.classList.toggle(`dark`, f === `dark`),
      ...
      window.localStorage.setItem(`teks-theme`, f));
  }, [f]),
    (0, _.useEffect)(
      () => window.localStorage.setItem(`teks-provider`, m),
      [m],
    ),
    (0, _.useEffect)(() => {
      (fetch(`/api/_teks/provider`)
        .then((e) => {
          if (!e.ok) throw Error(`Could not load provider`);
          return e.json();
        })
        .then((e) => h(e.provider))
        .catch(() => x(`Could not load provider`)),
        fetch(`/api/_teks/messages`)
          .then((e) => {
            if (!e.ok) throw Error(`Could not load messages`);
            return e.json();
          })
          .then((e) => {
            (t(e), r(e[0]?.to ?? null));
          })
          .catch(() => x(`Could not load messages`))
          .finally(() => s(!1)));
      let e = new EventSource(`/api/events`);
      return (
        (e.onopen = () => l(!0)),
        (e.onerror = () => l(!1)),
        e.addEventListener(`new-message`, (e) => {
          let n = JSON.parse(e.data);
          (t((e) => [n, ...e.filter((e) => e.id !== n.id)]),
            r((e) => e ?? n.to));
        }),
        () => e.close()
      );
    ...
    (0, _.useEffect)(() => {
      n && !e.some((e) => e.to === n) && r(e[0]?.to ?? null);
    }, [e, n]));
  let ee = (0, _.useMemo)(() => {
    if (!n) return null;
    let t = e
      .filter((e) => e.to === n)
      .sort((e, t) => Date.parse(e.created_at) - Date.parse(t.created_at));
    return t.length
      ? { recipient: n, messages: t, latest: t[t.length - 1] }
      : null;
  }, [e, n]);
  function x(e) {
    (d(e), window.setTimeout(() => d(null), 1800));
  }
  async function ne(e, t = `Copied`) {
    (await navigator.clipboard.writeText(e), x(t));
  }
  async function re(e) {
    try {
      let t = await fetch(`/api/_teks/provider`, {
        method: `PUT`,
        headers: { "Content-Type": `application/json` },
        body: JSON.stringify({ provider: e }),
      });
      if (!t.ok) return (x(`Could not change provider`), !1);
      let n = await t.json();
      return (h(n.provider), x(`${te(n.provider)} selected`), !0);
    } catch {
      return (x(`Could not change provider`), !1);
    }
  }
  function C() {
  ...
  async function ie(e) {
    if (window.confirm(`Delete this message?`)) {
      if (
        !(await fetch(`/api/_teks/messages/${e.id}`, { method: `DELETE` })).ok
      )
        return x(`Could not delete message`);
      (t((t) => t.filter((t) => t.id !== e.id)), a(null), x(`Message deleted`));
    }
  }
  async function ae() {
    if (
      window.confirm(`Delete every captured message? This cannot be undone.`)
    ) {
      if (!(await fetch(`/api/_teks/messages`, { method: `DELETE` })).ok)
        return x(`Could not clear messages`);
      (t([]), r(null), x(`Inbox cleared`));
    }
  }
  async function oe(e) {
    if (
      !window.confirm(
        `Delete all ${e.messages.length} messages for ${e.recipient}?`,
      )
    )
      return;
    let n = await Promise.all(
        e.messages.map(async (e) => ({
          id: e.id,
          deleted: (
            await fetch(`/api/_teks/messages/${e.id}`, { method: `DELETE` })
          ).ok,
        })),
      ),
      i = new Set(n.filter((e) => e.deleted).map((e) => e.id));
    (t((e) => e.filter((e) => !i.has(e.id))),
      a(null),
      i.size === e.messages.length
        ? (r(null), x(`Conversation deleted`))
        : x(`Deleted ${i.size} of ${e.messages.length} messages`));
  }
  return y
    ? (0, S.jsxs)(S.Fragment, {
        children: [
          (0, S.jsx)(qe, {
            ...
            onSelect: re,
            onComplete: C,
            onClose: g ? () => b(!1) : void 0,
          }),
          u && (0, S.jsx)(Ye, { text: u }),
        ],
      })
    : (0, S.jsxs)(`main`, {
        className: `h-dvh bg-[#f2f2f2] dark:bg-[#0d0d0f]`,
        children: [
          (0, S.jsxs)(`section`, {
            className: `grid h-full min-h-0 w-full grid-cols-1 overflow-hidden lg:grid-cols-[300px_minmax(0,1fr)] lg:gap-2 xl:grid-cols-[300px_minmax(0,1fr)_400px]`,
            children: [
              (0, S.jsx)(Je, {
                messages: e,
                loading: o,
...
v.createRoot(document.getElementById(`root`)).render(
  (0, S.jsx)(_.StrictMode, { children: (0, S.jsx)(nt, {}) }),
);
