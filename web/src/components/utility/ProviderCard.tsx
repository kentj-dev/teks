...
import { providerIcon, useProviderSpec } from '../../providers';
    ...
    <section className="mt-4">
      ...
      >
        <span className="grid h-8 w-8 shrink-0 place-items-center rounded-md bg-accent/10 text-accent">
          <Icon name={providerIcon(spec)} className="h-4 w-4" />
        </span>
        <span className="min-w-0 flex-1">
          <span className="block text-xs font-medium">{spec?.label ?? provider}</span>
