...
export function PayloadPanel({
  ...
  return (
    <section className={compact ? 'mt-4' : 'mt-6'}>
      ...
      <pre
        className={`scrollbar-none overflow-auto bg-[#171719] dark:bg-[#1F1F21] dark:text-white text-[#d6d6db] ${compact ? 'max-h-64 rounded-lg p-3 text-[10px] leading-5' : 'rounded-2xl p-4 text-[11px] leading-5'}`}
      >
        <code>{formatted}</code>
      </pre>
    </section>
